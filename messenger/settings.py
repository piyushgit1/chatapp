...
SECRET_KEY = '!_pq7)03wzzo+euewq))6d+e&5um(#pu@bxga)oy&hvtlcr*du'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'messenger/mapp/templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = '/home/piyush/Desktop/messenger/mapp'
